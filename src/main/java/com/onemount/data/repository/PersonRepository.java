...
public class PersonRepository {
    ...
    */
    ...
    //3.1 Trả về danh sách 'developer' ở các thành phố Hà nọi, saigon Shanghai

    public Map<String, List<Person>> countryMap() {
    ...
    public List<Map.Entry<String, Double>> citiesHasTopAgeForDeveloper() {
